...
const GameCascadeArea: React.FC<GameCascadeAreaProps> = ({
  ...
  return (
    <div className="w-full order-1 lg:order-2 animate-in slide-in-from-right-4 duration-1000 delay-500">
      {/* Enhanced Cascade Visualization - Full Width */}
      <Card className="w-full bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl dark:bg-white/5 light:bg-black/5 light:border-black/10 mb-6 transform hover:scale-[1.01] transition-all duration-300">
      ...
      {/* Enhanced Factor Selection Panel - Full Width */}
      <Card className="w-full bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl dark:bg-white/5 light:bg-black/5 light:border-black/10 transform hover:scale-[1.01] transition-all duration-300">
