...
const GameCascadeArea: React.FC<GameCascadeAreaProps> = ({
  ...
  return (
    <div className="w-full space-y-3">
      {/* Top Section - Left and Right Factors with Center Game Area */}
      <div className="flex gap-4">
        ...
        <div className="w-48">
          <Card className="glassmorphic-card bg-white/5 backdrop-blur-xl border border-white/10 shadow-xl">
            <CardContent className="p-3">
              <h4 className="text-blue-400 font-bold text-sm text-center mb-2 flex items-center justify-center glassmorphic-card p-2 rounded-lg bg-blue-900/20 border border-blue-400/30">
              ...
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-lg font-bold text-white flex items-center">
                  <div className="relative mr-2">
                    ...
                    <div className="absolute inset-0 h-5 w-5 bg-red-400/30 rounded-full animate-ping"></div>
                  </div>
                  Interactive Coagulation Cascade
                  <Sparkles className="h-4 w-4 ml-2 text-yellow-400 animate-pulse" />
                </h3>
                
                <div className="glassmorphic-card text-white text-sm bg-white/10 px-3 py-1 rounded-xl backdrop-blur-sm border border-white/20">
        ...
        <div className="w-48 space-y-3">
          <Card className="glassmorphic-card bg-white/5 backdrop-blur-xl border border-white/10 shadow-xl">
            <CardContent className="p-3">
              <h4 className="text-green-400 font-bold text-sm text-center mb-2 flex items-center justify-center glassmorphic-card p-2 rounded-lg bg-green-900/20 border border-green-400/30">
          ...
          <Card className="glassmorphic-card bg-white/5 backdrop-blur-xl border border-white/10 shadow-xl">
            <CardContent className="p-3">
              <h4 className="text-cyan-400 font-bold text-sm text-center mb-2 flex items-center justify-center glassmorphic-card p-2 rounded-lg bg-cyan-900/20 border border-cyan-400/30">
